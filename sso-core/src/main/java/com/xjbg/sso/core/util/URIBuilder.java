...
public final class URIBuilder {
    ...
    private String encodeUserInfo(final String userInfo) {
        return this.encode ? CommonUtil.urlEncode(userInfo) : userInfo;
    }

    private String encodePath(final String path) {
        return this.encode ? CommonUtil.urlEncode(path) : path;
    }

    private String encodeUrlForm(final List<BasicNameValuePair> params) {
        final StringBuilder result = new StringBuilder();
        for (final BasicNameValuePair parameter : params) {
            final String encodedName = this.encode ? CommonUtil.urlEncode(parameter.getName()) : parameter.getName();
            final String encodedValue = this.encode ? CommonUtil.urlEncode(parameter.getValue()) : parameter.getValue();
    ...
    private String encodeUric(final String fragment) {
        return this.encode ? CommonUtil.urlEncode(fragment) : fragment;
    }
