package com.xjbg.sso.core.cache;


import com.google.common.collect.Sets;
import com.xjbg.sso.core.util.CollectionUtil;
import com.xjbg.sso.core.util.JsonUtil;
...
public class CacheTemplate {
    ...
    public <T> List<T> valueGetList(String key, Class<T> valueClass) {
        ...
        return JsonUtil.toArray(valueJson, valueClass);
    }
    ...
    public <T> List<T> hashGetList(String key, String hashKey, Class<T> valueClass) {
        ...
        return StringUtil.isNotBlank(hashValueJson) ? JsonUtil.toArray(hashValueJson, valueClass) : Collections.emptyList();
    }
    ...
    public <T> List<List<T>> hashMultiGetList(String key, Collection<String> hashKeys, Class<T> hashValueClass) {
        ...
        for (String value : hashValueJsonList) {
            values.add(JsonUtil.toArray(value, hashValueClass));
        }
        return values;
    }
